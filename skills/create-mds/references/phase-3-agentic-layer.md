...
Don't continue until the user agrees to these defaults (or specifies overrides — but v0.10.0 only documents the defaults; overrides are user-responsibility).
