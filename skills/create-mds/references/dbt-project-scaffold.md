...
If the client will use dbt utility packages (date helpers, generic tests, etc.), add a packages.yml at the project root and run `dbt deps` once. Skip in v0.1 unless the user asks; most starters don't need it.
