...
- **Service account key creation disabled** → some orgs disable key creation in Org Policy. If so, fall back to workload identity federation (advanced; not in v0.9.0 scope).
